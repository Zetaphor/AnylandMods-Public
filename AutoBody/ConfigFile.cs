    ...
    class ConfigFile : ModConfigFile {
        ...
        private ref SavedAttachmentList GetListRefForAttachmentPoint(AttachmentPointId point)
        {
            switch (point) {
                ...
                case AttachmentPointId.ArmLeft: case AttachmentPointId.HandLeft: return ref listArmLeft;
                case AttachmentPointId.ArmRight: case AttachmentPointId.HandRight: return ref listArmRight;
